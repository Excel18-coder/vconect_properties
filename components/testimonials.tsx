...
const testimonials = [
  { name: 'Sarah Mwangi', role: 'Home Buyer', avatar: 'SM', rating: 5, text: 'VConnect made finding our dream home so easy. The verified sellers gave us confidence, and the team was incredibly supportive throughout the process.' },
  { name: 'James Ochieng', role: 'Property Investor', avatar: 'JO', rating: 5, text: 'As an investor, I need reliable data and verified listings. VConnect delivers both. Their analytics dashboard helps me make informed decisions quickly.' },
  { name: 'Grace Wanjiku', role: 'First-time Buyer', avatar: 'GW', rating: 5, text: 'Being a first-time buyer was daunting, but VConnect guided me every step. From search to closing, the experience was seamless and professional.' },
];
