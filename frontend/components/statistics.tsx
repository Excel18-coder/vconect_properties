...
const stats = [
  { icon: Building2, value: 150, suffix: '+', label: 'Properties Listed' },
  { icon: Users, value: 5, suffix: '+', label: 'Verified Agents' },
  { icon: Handshake, value: 100, suffix: '+', label: 'Successful Deals' },
  { icon: Eye, value: 5, suffix: 'K+', label: 'Monthly Views', isDecimal: true },
];
