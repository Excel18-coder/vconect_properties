...
const categories = [
  { id: 'apartment', label: 'Apartments', icon: Building2, count: 50, image: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=400' },
  { id: 'house', label: 'Houses', icon: Home, count: 47, image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=400' },
  { id: 'villa', label: 'Villas', icon: Castle, count: 20, image: 'https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=400' },
  { id: 'townhouse', label: 'Townhouses', icon: Warehouse, count: 23, image: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=400' },
  { id: 'commercial', label: 'Commercial', icon: Store, count: 16, image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=400' },
  { id: 'office', label: 'Offices', icon: Briefcase, count: 32, image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=400' },
  { id: 'land', label: 'Land', icon: TreePine, count: 10, image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=400' },
];
